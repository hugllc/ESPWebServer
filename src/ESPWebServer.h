/*
  ESPWebServer.h - Dead simple web-server.
...
template<typename T> size_t streamFile(T &file, const String& contentType){
  ...
  // SLP This should be put back in when the write is supported.
  return 0; //_currentClient.write(file, HTTP_DOWNLOAD_UNIT_SIZE);
}
